...
export const GRAPH_DATA: GraphData = {
    nodes: [
        ...
        { id: 'seyda', label: 'Marian Seyda', group: 'thinker', level: 3, start: '1879-07-07', end: '1967-05-17', description: 'Key Endecja leader in Poznań, editor-in-chief of Kurier Poznański, and minister in the Polish Gov\'t-in-Exile.', image: 'https://i.ibb.co/5xhf0dM/seyda.jpg' },
        { 
            id: 'gorski', 
            label: 'Artur Górski', 
            group: 'thinker', 
        ...
        { id: 'kurier_poznanski', label: 'Kurier Poznański', group: 'publication', level: 2, start: '1872', end: '1939', description: 'The largest non-Warsaw daily paper associated with the Endecja, serving as its factual press organ in Poznań.', image: 'https://i.ibb.co/pwn02Nf/kurier.jpg' },
        {
            id: 'mysl_narodowa',
            label: 'Myśl Narodowa',
            group: 'publication',
